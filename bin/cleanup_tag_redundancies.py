...
def cleanup_toml_tags(toml_path: str, output_path: str = None, dry_run: bool = True) -> Dict[str, Any]:
...
def main():
    ...
    print(f"=== Tag Redundancy Cleanup ===")
    ...
    try:
        ...
        if not args.apply:
            ...
            print(f"Key redundancy: {stats['homebrew_redundancies']} packages have pm:homebrew redundancy")
