...
return {
  ...
  config = function()
    ...
    local inactive_primary_color = {
      fg = require("ashebanow.util").getColor("Normal", "bg"),
      bg = require("ashebanow.util").getColor("Grey", "fg"),
    }
    ...
    require("lualine").setup({
      options = {
        theme = function()
          ...
          -- better ;)
          local colors = {
            normal = require("ashebanow.util").getColor("Yellow", "fg"),
            insert = require("ashebanow.util").getColor("Green", "fg"),
            visual = require("ashebanow.util").getColor("Purple", "fg"),
            replace = require("ashebanow.util").getColor("Red", "fg"),
            command = require("ashebanow.util").getColor("Orange", "fg"),
            bg = require("ashebanow.util").getColor("Normal", "bg"),
          }
      ...
      inactive_sections = {
        ...
        lualine_c = {
          ...
          },
          {
            ...
            color = { fg = require("ashebanow.util").getColor("Grey", "fg") },
          },
        },
        lualine_x = {},
        lualine_y = {},
